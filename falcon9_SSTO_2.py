...
def get_rocket_acceleration(x,y,t, vx, vy):
    ...
    elif t >= burn_time_2_start and t <= burn_time_2_end and propellant_mass > h*3*m1D_flow_rate:  
        engines_on = True
        second_stage_cut_off = t
        flow_rate = 3.*m1D_flow_rate
        thrust_total = flow_rate*isp
        thrust_angle = 0.
